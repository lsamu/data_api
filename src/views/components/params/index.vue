<template>
    <div>
        <el-button  type="primary" @click="handleInsert" icon="el-icon-plus">添加</el-button>
        <el-table :data="props.modelValue" style="width: 100%" :height="useThat.sizeOption.global.height - useThat.sizeOption.footer.height - 280">
            ...
            <el-table-column prop="key" label="操作" width="90">
                <template #default="scope">
